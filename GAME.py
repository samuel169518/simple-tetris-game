...
COLORS = ['gray', 'lightgreen', 'darkgreen', 'blue', 'yellow', 'purple']
...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.status_msg = tk.Label(self, anchor='w', width=15, font=("Courier", 20))
        ...
        self.game_name_crater = tk.Label(self, anchor='w', width=20, font=("Courier", 15), fg='red')
        self.game_name_crater.pack(side="bottom")
    ...
    def update(self):
        ...
        self.game_name_crater['text']= "thanks for M.Samuel."
